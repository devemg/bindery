...
export function BinderyWizard() {
  ...
  return (
    <div className="wizard-shell flex min-h-screen flex-col items-center justify-between gap-16 bg-page px-40 pb-64 pt-44 font-body text-ink">
      <div className="wizard-content mx-16 flex w-full max-w-page flex-col gap-34">
        <Header />
